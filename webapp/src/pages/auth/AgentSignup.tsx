...
interface AgentSignupFormValues {
  name: string;
  email: string;
  phone: string;
  password: string;
...
export default function AgentSignup() {
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm<AgentSignupFormValues>({ mode: "onBlur" });

  const passwordValue = watch("password");

  const onSubmit = async (values: AgentSignupFormValues) => {
  ...
  return (
    <AuthLayout
      ...
      subtitle="List and manage properties on Hauzisha"
    >
      {isSuccess ? (
